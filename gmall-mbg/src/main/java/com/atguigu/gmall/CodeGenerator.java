...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        gc.setOutputDir("D:\\Idea-workplace1\\gmall_parent\\gmall-mbg" + "/src/main/java");
        gc.setAuthor("Lfx");
        ...
        dsc.setUrl("jdbc:mysql://192.168.238.200:3307/gmall_"+moduleName+"?useUnicode=true&useSSL=false&characterEncoding=utf8");
